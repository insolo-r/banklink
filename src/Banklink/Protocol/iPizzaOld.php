...
use Banklink\Protocol\iPizzaOld\Fields,
    Banklink\Protocol\iPizzaOld\Services;
 ...
 * @since  11.01.2012
 */
class iPizzaOld implements ProtocolInterface
{
    protected $publicKey;
    ...
    public function preparePaymentRequestData($orderId, $sum, $message, $outputEncoding, $language = 'EST', $currency = 'EUR')
    {
        $requestData = array(
        	...
        	Fields::VK_DATETIME		 => date(DATE_ISO8601, time()),
        );
